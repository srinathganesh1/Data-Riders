...
km.res <- kmeans(df, 3, nstart = 25)#df is scaled data, default uses euclidean method
km.res
km.res$cluster
# Visualize
...
aggregate(data,list(cluster=km.res$cluster),mean)#vecotr wont work so made list
